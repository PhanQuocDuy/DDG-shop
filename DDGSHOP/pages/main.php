 ...
 <section class="home-categorize home-cate-feature">
                    ...
                    <div class="listCategorize row">
                            ...
                            <div class="item-icon">
                                <div class="item-img boxlazy-img">
                                    <span class="boxlazy-img__insert">
                                        <img src="./DDGSHOP/img/DMNB/cate_feature_6_img.webp" alt="Chuột máy tính" class=" ls-is-cached lazyloaded">
                                    </span>
                                </div>
                                <div class="item-title">
                                    <h3>Chuột máy tính</h3>
                                </div>
                                <a href="" aria-label="Chuột máy tính" class="item-link"></a>
                            </div>
                        </div>
                        <div class="col7-cus">
                            <div class="item-icon">
                                <div class="item-img boxlazy-img">
                                    <span class="boxlazy-img__insert">
                                        <img src="./DDGSHOP/img/DMNB/cate_feature_7_img.webp" alt="Màn hình máy tính" class=" ls-is-cached lazyloaded">
                                    </span>
                                </div>
                                <div class="item-title">
                                    <h3>Màn hình máy tính</h3>
                                </div>
                                <a href="" aria-label="Màn hình máy tính" class="item-link"></a>
                            </div>
                        </div>
                        <div class="col7-cus">
                            <div class="item-icon">
                                <div class="item-img boxlazy-img">
                                    <span class="boxlazy-img__insert">
                                        <img src="./DDGSHOP/img/DMNB/cate_feature_8_img.webp" alt="Loa bluetooth" class=" ls-is-cached lazyloaded">
                                    </span>
                                </div>
                                <div class="item-title">
                                    <h3>Loa bluetooth</h3>
                        ...
                        <div class="col7-cus">
                            <div class="item-icon">
                                <div class="item-img boxlazy-img">
                                    <span class="boxlazy-img__insert">
                                        <img src="./DDGSHOP/img/DMNB/cate_feature_9_img.webp" alt="Tai nghe" class=" ls-is-cached lazyloaded">
                                    </span>
                                </div>
                                <div class="item-title">
                                    <h3>Tai nghe</h3>
                        ...
                        <div class="col7-cus">
                            <div class="item-icon">
                                <div class="item-img boxlazy-img">
                                    <span class="boxlazy-img__insert">
                                        <img src="./DDGSHOP/img/DMNB/cate_feature_10_img.webp" alt="Sạc dự phòng" class=" ls-is-cached lazyloaded">
                                    </span>
                                </div>
                                <div class="item-title">
                                    <h3>Sạc dự phòng</h3>
                        ...
                        <div class="col7-cus">
                            <div class="item-icon">
                                <div class="item-img boxlazy-img">
                                    <span class="boxlazy-img__insert">
                                        <img src="./DDGSHOP/img/DMNB/cate_feature_12_img.webp" alt="Bàn phím máy tính" class=" ls-is-cached lazyloaded">
                                    </span>
                                </div>
                                <div class="item-title">
                        ...
                        <div class="col7-cus">
                            <div class="item-icon">
                                <div class="item-img boxlazy-img">
                                    <span class="boxlazy-img__insert">
                                        <img src="./DDGSHOP/img/DMNB/cate_feature_13_img.webp" alt="Cáp sạc" class=" ls-is-cached lazyloaded">
                                    </span>
                                </div>
                                <div class="item-title">
                                    <h3>Cáp sạc</h3>
    ...
    <section class="home-productTabs home-productTabs-1">
        <div class="container container-pd-parent">
            <div class="section-heading">
                <h2 class="hTitle">Màn hình máy tính</h2>
            </div>
            <div class="wrapbox row-mg-parent">
                        ...
                        <div class="tab-pane fade  active show" id="coll-1-tab-1" role="tabpanel" data-get="true">
                            <div class="row listProduct-row">
                                ...
                                <div class="col-lg-cus5 col-md-6 col-6 product-loop" data-id="1104966306">
                                    <div class="product-inner" data-proid="1046543121" id="section_1_tab_1_loop_10">
                                        <div class="proloop-image">
                                            ...
                                            <div class="product--image">
                                                <div class="lazy-img first-image">
                                                    <picture>
                                                        ...
                                                        <img class="img-loop ls-is-cached lazyloaded" src="" alt=" Màn hình Asus ProArt PA278QV-P (27 inch/WQHD/IPS/75Hz/5ms) ">
                                                    </picture>
                                                </div>
                                            ...
                                            <a href="" class="proloop-link quickview-product" title="Màn hình Asus ProArt PA278QV-P (27 inch/WQHD/IPS/75Hz/5ms)"></a>
                                        </div>
                                        <div class="proloop-detail">
                                            <div class="proloop--top">
                                                <p class="proloop--vendor"><a title="Show vendor" href="">ASUS</a></p>
                                            </div>
                                            <h3><a href="" class="quickview-product">Màn hình Asus ProArt PA278QV-P
                                                    (27inch/WQHD/IPS/75Hz/5ms)</a>
                                            </h3>
                                                ...
                                                <div class="proloop-actions__inner">
                                                    ...
                                                    <div class="actions-boxqty d-flex">
                                                        <div class="actions-icon">
                                                            <span class="btnico" onclick="HRT.All.addCartProdItem('1104966306')" title="Thêm vào giỏ">
                ...
                <div class="wrapbox--btn ">
                    <a href="./ALLManHinh.html" class="button btn-loadmore">Xem tất cả <strong>Màn hình</strong></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="home-productTabs home-productTabs-1">
        <div class="container container-pd-parent">
            <div class="section-heading">
                <h2 class="hTitle">Card đồ họa</h2>
            </div>
            <div class="wrapbox row-mg-parent">
                <div class="wrapbox--right">
                    <div class="tab-content collection-tabs-ajax">
                ...
                <div class="wrapbox--btn ">
                    <a href="" class="button btn-loadmore">Xem tất cả <strong>Card đồ họa</strong></a>
                </div>
            </div>
        </div>
    </section>