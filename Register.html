                    ...
                    <div class="userbox customers_accountForm">
                        ...
                        <form accept-charset="UTF-8" action="/account" id="create_customer" method="post">
                            ...
                            <div id="field-lastname" class="clearfix large_form">
                                ...
                                <input required="" type="text" value="" name="customer[last_name]" placeholder="Họ"
                            ...
                            <div id="field-firstname" class="clearfix large_form">
                                <label for="first_name" class="label icon-field"><i
                                        class="icon-login icon-user "></i></label>
                                <input required="" type="text" value="" name="customer[first_name]" placeholder="Tên"
                            ...
                            <div id="field-birthday" class="clearfix large_form">
                                <label for="birthday" class="label icon-field"><i
                            ...
                            <div id="field-password" class="clearfix large_form large_form-mrb">
                                ...
                                <input required="" type="password" value="" placeholder="Mật khẩu"
                                    name="customer[password]" id="password" class="password text" size="30">
                            </div>
                            ...
                            <div class="clearfix custommer_account_action">
                                ...
                                <div class="req_pass">Bạn đã có tài khoản? <a href="/Login.html">Đăng nhập ngay</a>
                                </div>
                            </div>

                            <input id="b8a033e49305465d85f1d111f3fba48e" name="g-recaptcha-response" type="hidden"
                                value="03AFcWeA6tV4Lk73q0FMkpKKMTa-kzYnU0UBSVhIEWKfyFw56X2yV1qPyUIptJyA7gkSyRSgVcsyF3axOgBzYwScdu2OcfyzCDZdjA4dAXm5O6bqYqach07SooWc_pzrx5n-Oe2qoGpAuGuh1aWQIw0yYWnfPRi_9cpoCQveIbdiTtdnHUMwZP8-Cc5goqCGsCeB5T45voa90rne3SkpsB-kC8cnPse6CbVMksAS9GnTwQ4JjGYNgU6T2LXriPwTkZlTnxINYTv1QwgHFf6YpMVfuL8Zwo0V8bKPcgox6kSi_Y-jSsITDrqp2OUz7vBKuHuoofx3sRgfvEz2Z7NuhtOlUQrXr4DvIuzifVJ57zSqeCgUcEMarmKC20bbgsFJlg_dUvwTnYx2Fy71rJxzBZHQCDcyDzEINa_Y2_WdM0FbLI2Mn7dJLwbOV2EtH_evhmrixY9BzDcVMe02VvRS12pISozWPDE2Q32KFd3VuYQpLS5o73uEYLtwtOZJATt1dQE8h9IIIICMGtl4HARecPv6chU98htYK4xA">
                            <script
                                src="https://www.google.com/recaptcha/api.js?render=6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-"></script>
                            <script>grecaptcha.ready(function () { grecaptcha.execute('6LdD18MUAAAAAHqKl3Avv8W-tREL6LangePxQLM-', { action: 'submit' }).then(function (token) { document.getElementById('b8a033e49305465d85f1d111f3fba48e').value = token; }); });</script>
                        </form>
                        <!-- #register -->
                        <!-- #customer-register -->
                    </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-12">
                                    ...
                                    <ul class="footerNav-social">
                                        <li><a href="https://www.facebook.com/dattoon.nauhov/" target="_blank" rel=""
                                                title="Facebook" aria-label="Facebook"><i class=" ti-facebook"></i></a>
                                        </li>
